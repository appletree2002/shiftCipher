...
System.out.println("Encrypted Data of message ==> "+encryptData(inputStr, shiftKey));

System.out.println("Decrypted Data of message==> "+decryptData(encryptData(inputStr, shiftKey), shiftKey));
